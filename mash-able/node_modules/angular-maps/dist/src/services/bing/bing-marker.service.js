    ...
    BingMarkerService.prototype.UpdateIcon = function (marker) {
        return this._markers.get(marker).then(function (m) {
            if (marker.IconInfo) {
                ...
                bing_conversions_1.BingConversions.TranslateMarkerOptions(x_1).then(function (o) {
                    m.SetIcon(o.icon);
                    marker.DynamicMarkerCreated.emit(x_1.iconInfo);
                });
            }
            else {
...
//# sourceMappingURL=bing-marker.service.js.map